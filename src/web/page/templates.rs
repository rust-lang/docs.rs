...
pub mod filters {
    ...
    pub fn dbg<T: std::fmt::Display>(value: T) -> rinja::Result<String> {
    ...
    #[allow(clippy::unnecessary_wraps)]
    pub fn dedent<T: std::fmt::Display>(value: T, levels: Option<i64>) -> rinja::Result<String> {
    ...
    pub fn highlight(code: &str, lang: &str) -> rinja::Result<String> {
    ...
    pub fn filesizeformat(num: usize) -> rinja::Result<String> {
